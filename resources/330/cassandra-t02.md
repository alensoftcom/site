...
Apache Cassandra is also available as a tarball or package [download](https://cassandra.apache.org/_/download.html).
...
- Read through the [Cassandra Basics](https://cassandra.apache.org/_/cassandra-basics.html) to learn main concepts and how Cassandra works at a high level.
    
- To understand Cassandra in more detail, head over to the [Docs](https://cassandra.apache.org/doc/latest/).
    
- Browse through the [Case Studies](https://cassandra.apache.org/_/case-studies.html) to learn how other users in our worldwide community are getting value out of Cassandra.
